...
//Vud 92-3.8, eshabilitamos el proxi--SECCION 9 Trzabilidad
@Configuration(proxyBeanMethods = false)
public class ObserverBeans {

    // Enpezamos a configurar los Beans
    @Bean
    ...
    // V-93,ya estab deprecado ,pero la hace de forma manual, configurar el open
    // telemetric
    @Bean
    ...
    public LogRecordProcessor logRecordProcessor() {
        ...
        return BatchLogRecordProcessor
                // se lo pasamos como constructor
